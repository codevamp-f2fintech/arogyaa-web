...
const ModalOne: React.FC<ModalProps> = React.memo(
  ({ isOpen, onClose, data }) => {
    const [loading, setLoading] = useState<boolean>(false);
    const [showPaymentForm, setShowPaymentForm] = useState<boolean>(false);
      ...
      const fetchBookedSlots = async () => {
        ...
        try {
          ...
          const bookedTimes = response.results
            .filter(
              (appt) =>
                dayjs(appt.appointmentDate).format("YYYY-MM-DD") ===
                selectedDate
            )
            .map((appt) => appt.appointmentTime);
                            ...
                            {({ field }) => (
                              ...
                              >
                                ...
                                >
                                  ...
                                  "Record a short video explaining your
                                  symptoms, This will help your doctor prepare
...
>>>>>>> Stashed changes
                                ...
                                >
                                  Supported formats: MP4, MOV, AVI (max size
                                  50MB)
                                </Typography>
                              </Box>
                            )}
