...
const SliderComponent = ({ images }) => {
 ...
 <p sx={{ paddingBottom:'20px', textAlign:'left'}} style={{textAlign:'left', marginTop:'15px',    fontSize: '.9rem',
    fontWeight: 'normal',
    color: '#252525',
    lineHeight: '1.5rem'}}> {image.description}</p>
<div style={{display:'flex', alignItems:'center', marginTop:'15px'}}>
<img src="../assets/images/filled_star.png" style={{width:'40px'}}/>
<img src="../assets/images/filled_star.png"  style={{width:'40px'}}/>
<img src="../assets/images/filled_star.png"  style={{width:'40px'}}/>
<img src="../assets/images/filled_star.png"  style={{width:'40px'}}/>
<img src="../assets/images/filled_star.png"  style={{width:'40px'}}/>
      ...
      <div className="slider-nav">
        <Slider {...settingsNav} ref={sliderNavRef}>
          {images.map((image, index) => (
            <div sx={{ display:'flex', alignItems:'center', borderRadius:'30px'}}>
